...
mod slice_ext {
        ...
        F: FnMut(&T) -> std::cmp::Ordering,
    {
        ...
        // the stdlib implementation optimizes better. This branch is fully
        // resolved at compile-time and will not incur any space or runtime overhead.
        ...
        // This is a custom binary search implementation that allows for early return
        // when the comparison function returns `Equal`, which is best when the comparison
        // function isn't trivial (e.g. `memcmp` vs. integer comparison).
        ...
        while low < high {
            ...
            // TODO: Use select_unpredictable when available
